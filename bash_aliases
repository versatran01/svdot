...
alias cbr='catkin build -j6 --cmake-args -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wall -Wno-deprecated-copy" -DBUILD_TESTING=Off -- '
alias cbd='catkin build -j6 --cmake-args -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_CXX_FLAGS="-Wall -Wno-deprecated-copy" -DBUILD_TESTING=Off  -- '
alias cbt='catkin build -j6 --cmake-args -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wall -Wno-deprecated-copy" -DBUILD_TESTING=On -- '
alias crt='catkin build -j6 --verbose --cmake-args -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wall -Wno-deprecated-copy" -DBUILD_TESTING=On --make-args test -- '
