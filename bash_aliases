...
alias cbr='catkin build -j8 --cmake-args -DCAMEK_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wall -Wno-deprecated-copy -fdiagnostics-color=always" -DBUILD_TESTING=Off -- '
alias cbd='catkin build -j8 --cmake-args -DCAMEK_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=RelWithDebInfo -DCMAKE_CXX_FLAGS="-Wall -Wno-deprecated-copy -fdiagnostics-color=always" -DBUILD_TESTING=Off  -- '
alias cbt='catkin build -j8 --cmake-args -DCAMEK_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wall -Wno-deprecated-copy -fdiagnostics-color=always" -DBUILD_TESTING=On -- '
alias crt='catkin build -j8 --verbose --cmake-args -DCAMEK_CXX_COMPILER_LAUNCHER=ccache -DCMAKE_BUILD_TYPE=Release -DCMAKE_CXX_FLAGS="-Wall -Wno-deprecated-copy -fdiagnostics-color=always" -DBUILD_TESTING=On --make-args test -- '
